			...
			<fieldset>
				...
				<div class="one-input box-crdNo">
					...
					<div class="box-input">
						...
						<input id="crdNo1" class="style-input" type="text" maxlength="4">
						<input id="crdNo2" class="style-input" type="text" maxlength="4">
						<input id="crdNo3" class="style-input" type="text" maxlength="4">
